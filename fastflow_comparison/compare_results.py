...
MOJO_RESULTS_DIR = os.path.join('..', 'image_processing', 'results')
PLOTS_DIR = os.path.join(FF_RESULTS_DIR, 'plots')
...
def load_results():
    ...
    # FastFlow results
    ff_file = os.path.join(FF_RESULTS_DIR, 'source_rate_512.txt')
