// Test Spot — FastFlow V4 stages (planar layout), configurazione singola da linea di comando
//
// Uso:
//   ./test_spot <G> <B> <S>
//
...
int main(int argc, char* argv[]) {
    ...
    std::printf("======================================================================\n");
    std::printf("  Test Spot (FastFlow V4 — planar layout) — configurazione singola\n");
