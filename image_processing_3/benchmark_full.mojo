# Test Spot Benchmark — V3 stages (SIMD on GaussianBlur and Sharpen)
#
# Structure:
...
#   Phase 3: Optimal config   — G=3 B=8 S=8  (tuned for V3 SIMD stage costs, 21 threads)
#
# V2 baseline costs: Gray=0.660ms  Blur=2.270ms  Sharp=2.976ms  per image
# V3 stage costs:    Gray=0.627ms  Blur=1.675ms  Sharp=1.735ms  per image (SIMD)
...
def main():
    print("=" * 70)
    print("  Test Spot Benchmark (V3 stages — SIMD Blur+Sharpen)")
