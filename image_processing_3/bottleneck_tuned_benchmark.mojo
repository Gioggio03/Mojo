# Bottleneck-Tuned Parallel Benchmark — V3 (SIMD stages)
#
# Cambia G, B, S, poi esegui: ./run_tuning.sh

from MoStream import Pipeline, seq, parallel
from image_stages_3 import TimedImageSource, Grayscale, GaussianBlur, Sharpen, ImageSink
...
# ============================================================================
# >>> CAMBIA QUI <<<
comptime G: Int = 4   # Grayscale workers
