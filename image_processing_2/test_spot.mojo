# Test Spot — V2 stages, configurazione singola da linea di comando
#
# Uso:
#   mojo run test_spot.mojo <G> <B> <S>
#
# Esempio:
#   mojo run test_spot.mojo 2 7 10
#
...
def main():
    ...
    if len(args) != 4:
        ...
        print("Esempio: mojo run test_spot.mojo 2 7 10")
        return
    ...
    print("=" * 70)
    print("  Test Spot (V2 stages) — configurazione singola")
