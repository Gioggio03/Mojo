# Bottleneck-Tuned Parallel Benchmark
#
# Cambia G, B, S, poi esegui: ./run_tuning.sh

from MoStream import Pipeline, seq, parallel
from image_stages_2 import TimedImageSource, Grayscale, GaussianBlur, Sharpen, ImageSink
...
comptime B: Int = 7  # GaussianBlur workers
comptime S: Int = 10   # Sharpen workers
# ============================================================================
...
def main():
    ...
    print("G=" + String(G) + " B=" + String(B) + " S=" + String(S) + " | threads=" + String(total_threads) + " | " + String(n) + " imgs | " + String(tput) + " img/s")
    print("| G=" + String(G) + " B=" + String(B) + " S=" + String(S) + " (" + String(total_threads) + " threads) | " + String(tput) + " img/s | " + String(n) + " imgs |")
